...
import Logo from "../public/navnath_img.jpg"
...
const SkillsDashboard = () => {
  ...
  const skillCategories = {
    ...
    backend: {
      ...
      skills: [
        { name: "Node.js", level: 75, experience: "6 months", projects: 5, icon: "🟢" },
        { name: "Express.js", level: 70, experience: "6 months", projects: 4, icon: "🚂" },
        { name: "MongoDB", level: 65, experience: "6 months", projects: 3, icon: "🍃" },
        { name: "REST APIs", level: 80, experience: "6 months", projects: 6, icon: "🔗" },
        { name: "Python", level: 65, experience: "Learning", projects: 3, icon: "🐍" },
        { name: "PostgreSQL", level: 60, experience: "Learning", projects: 2, icon: "🐘" },
      ],
    },
    tools: {
      title: "Tools & Design",
      ...
      <div className="flex flex-wrap justify-center gap-6 mb-16">
        {Object.entries(skillCategories).map(([key, category]) => (
          <motion.button
            ...
            className={`relative group overflow-hidden rounded-2xl p-6 transition-all duration-500 min-w-[200px] ${activeCategory === key
            ...
            >
              {navItems.map((item, index) => (
                <motion.button
                  ...
                  className={`text-base font-semibold transition-all duration-300 relative group px-3 py-2 ${activeSection === item.id ? "text-blue-600 dark:text-blue-400" : "text-gray-700 dark:text-gray-300"
                    }`}
                >
                  {item.label}
          ...
          >
            ...
            >
              <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent">
                <TextReveal delay={0.4}>Navnath</TextReveal>
              </span>{" "}
              <span className="inline-block">
                <TextReveal delay={0.8}>Taskar</TextReveal>
              </span>
            </motion.h1>
            ...
            >
              <a
                href="/Navnath_Taskar_Resume_Frontend_Developer.pdf"
                download="Navnath_Taskar_Resume_Frontend_Developer.pdf"
                ...
                {[
                  {
                    icon: Github,
                    text: "GitHub",
                    href: "https://github.com/Navnathtaskar-97",
                    isExternal: true
                  },
                  {
                    icon: Linkedin,
                    text: "LinkedIn",
                    href: "https://www.linkedin.com/in/navnath-taskar-08b04021b",
                    isExternal: true
                  },
                  {
                    icon: Mail,
                    text: "Email",
                    href: "mailto:navnathtaskar97@gmail.com",
                    isExternal: false
                  },
                ].map((social, index) => (
                  <a
              ...
              <Card className="overflow-hidden border-2 border-transparent hover:border-blue-200 dark:hover:border-blue-800 transition-all duration-300 shadow-xl">
                <CardHeader className="relative">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <CardTitle className="text-2xl"> B.E. in Mechanical engineering</CardTitle>
                      <CardDescription className="text-lg">SH.CHATRAPATI SHIVAJI COLLEGE OF ENGG., RAHURI
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">7.96 / 10</p>
                      </div>
                    </div>
                ...
                {[
                  {
                    icon: Mail,
                    title: "Email",
                    content: "navnathtaskar97@gmail.com",
                    color: "blue",
                    action: () => window.open("https://mail.google.com/mail/?view=cm&fs=1&to=navnathtaskar97@gmail.com&su=Contact%20from%20Portfolio&body=Hello%20Navnath,"),
                  },
                  {
                    icon: Phone,
                    title: "Phone",
                    content: "+91 8698118276",
                    color: "green",
                    action: () => window.open("https://wa.me/918698118276"),
                  },
                  {
                    icon: MapPin,
                    title: "Location",
                    content: "Shirdi, Maharashtra",
                    color: "purple",
                    action: () => window.open("https://www.google.com/maps/place/Shirdi,+Maharashtra"),
                  },
                ].map((item, index) => (
                  <motion.div
                    key={index}
                    ...
                    onClick={item.action}
                  >
                    <Card className="overflow-hidden border-2 border-transparent hover:border-blue-200 dark:hover:border-blue-800 transition-all duration-300 shadow-lg hover:shadow-xl">
                      <CardContent className="p-6">
                        <div className="flex items-center space-x-4">
                          <div
                            className={`p-3 bg-${item.color}-100 dark:bg-${item.color}-900 rounded-xl transition-colors group-hover:bg-${item.color}-200 dark:group-hover:bg-${item.color}-800`}
                          >
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 opacity-0 group-hover:opacity-100 transition-opacity">
                              Click to {item.title === "Phone" ? "chat on WhatsApp" : item.title === "Email" ? "send email" : "view on map"}
                            </p>
                          </div>
                ...
                >
                  <Card className="overflow-hidden border-2 border-transparent hover:border-blue-200 dark:hover:border-blue-800 transition-all duration-300 shadow-lg">
                    <CardContent className="p-6">
                      ...
                      <div className="space-y-4">
                        {[
                          { icon: Github, text: "GitHub Portfolio", href: "https://github.com/Navnathtaskar-97" },
                          {
                            icon: Linkedin,
                        ...
                        <MagneticButton
                          ...
                          onClick={() => {
                            try {
                              ...
                              link.href = "/Navnath_Taskar_Resume_Frontend_Developer.pdf"
                              link.download = "Navnath_Taskar_Resume_Frontend_Developer.pdf"
                              link.target = "_blank"
                              ...
                              window.open("/Navnath_Taskar_Resume_Frontend_Developer.pdf", "_blank")
                            }
                          }}
                        >
      ...
      >
        <div className="mx-3 relative">
          <div className="grid md:grid-cols-3 gap-12">
            ...
            >
              ...
              <div className="flex space-x-4">
                {[
                  { icon: Github, href: "https://github.com/Navnathtaskar-97" },
                  { icon: Linkedin, href: "https://www.linkedin.com/in/navnath-taskar-08b04021b" },
                  { icon: Mail, href: "mailto:navnathtaskar97@gmail.com" },
                ].map((social, index) => (
                  <Button
                    key={index}
                    variant="ghost"
            ...
            >
              ...
              <div className="space-y-3">
                <p className="text-gray-300 flex items-center space-x-2">
                  ...
                  <span>navnathtaskar97@gmail.com</span>
                </p>
                <p className="text-gray-300 flex items-center space-x-2">
                  <Phone className="h-4 w-4" />
                  <span>+91 8698118276</span>
                </p>
                <p className="text-gray-300 flex items-center space-x-2">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-gray-300 mb-2">© 2024 Navnath Taskar. All rights reserved.</p>
